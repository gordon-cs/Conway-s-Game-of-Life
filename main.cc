...
/**
    ...
    Counts how many of the neighboring cells are occupied by an organism
 
    Parameters:
    Cell - A given cell with neighbors you wish to count
 */


int countNeighbors(Cell cell){
    
    int coordinates = cell.getPosition();
    int X = coordinates;
    int Y = coordinates;
    
    // count neighbors in 3x3 square except for self in center square
